...
=======
    ...
    const char *message1 = "SIGNAL 1";
    i2c.transmit(testAddress, message1);
    Serial.println("Transmission 1 Sent");
    delay(1000);  // Delay to distinguish signals on oscilloscope

    // Second Transmission Signal
    const char *message2 = "SIGNAL 2";
    i2c.transmit(testAddress, message2);
    Serial.println("Transmission 2 Sent");
    delay(1000);

    // Third Transmission Signal
    const char *message3 = "SIGNAL 3";
